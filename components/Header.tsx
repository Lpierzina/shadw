      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <a href="#" className="flex items-center gap-3.5" aria-label="Autheo DevHub home">
          ...
          <div className="leading-none">
            ...
            <div className="mt-1 text-[9px] font-bold uppercase tracking-[0.16em] text-emerald-200/60">DevHub</div>
          </div>
        </a>
        <nav className="hidden items-center gap-8 text-xs font-medium text-emerald-50/70 md:flex">
