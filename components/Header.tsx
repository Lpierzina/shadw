    ...
    <header className="w-full border-b border-emerald-300/10 bg-[#031811]/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        <a href="#" className="flex items-center gap-3" aria-label="Autheo DevHub home">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#35e879] text-sm font-extrabold text-[#031811] shadow-[0_0_24px_rgba(53,232,121,0.3)]">A</div>
          <div className="leading-none">
            <div className="text-sm font-extrabold tracking-tight text-white">autheo</div>
            <div className="mt-0.5 text-[8px] font-bold uppercase tracking-[0.16em] text-emerald-200/60">DevHub</div>
          </div>
        </a>
