  ...
  return (
    <section className="grid gap-12 py-14 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:py-20">
      ...
      <div className="relative">
        ...
        <div className="relative overflow-hidden rounded-xl border border-[#35e879]/25 bg-[#08261b]/90 p-6 shadow-2xl shadow-black/40">
          <div className="flex items-center justify-between border-b border-emerald-50/10 pb-4">
            <div className="flex items-center gap-2 text-xs text-emerald-50/60"><span className="h-2 w-2 rounded-full bg-[#35e879]" />The Autheo Stack</div>
            <span className="rounded bg-[#35e879]/10 px-2.5 py-1.5 font-mono text-[10px] text-[#8dffae]">READY</span>
          </div>
